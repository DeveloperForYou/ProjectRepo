 ...
 */
public class StatoSitoLinux extends TimerTask  {
    
    String command ="curl -s https://checkip.amazonaws.com";
            ...
            Write(risultato);
               ...
               if(risultato.equals(dafile)){
                System.out.println("Stato del sito web online sull'indirizzo IP: "+risultato);
                   ...
                   email em=new email("admin@nomedominio.it","Stato del sito web online sull'indirizzo IP: "+risultato);
                   em.sendWithOutAttached("admin@nomedominio.it",
